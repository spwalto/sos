...
1. To edit existing man page ``.rst`` files, make changes within the directory where the corresponding file resides.
...
3. When creating a new man page, use the following naming convention: ``<category>_/-<functionality-name>.rst``
   - Example: ``sos_my-part.rst`` OR ``sos-my-part.rst``
   - For non-plugin files, include the type (e.g., ``sos/dsosd``) at the beginning of the filename.
...
5. Please follow the standard man page ``.rst`` formatting by including the following information at the top:
        ...
        ---------------------------------------------
        Description of my-part
        ---------------------------------------------

        :Date: YYYY-MM-DD
        :Version: vX.X
        :Manual section: X
        :Manual group: SOS my-part

Using Readthedocs
-------------------

To visualize and test your documentation changes on the offical [OVIS LDMS Documentation page](https://ovis-hpc.readthedocs.io/projects/sos/en/latest/) before submitting a PR, please follow the steps below.
